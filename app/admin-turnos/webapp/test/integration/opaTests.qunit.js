...
sap.ui.require(
  [
    ...
    "sap/ui/qunit/qunit-junit",
    "sap/ui/qunit/qunit-coverage",
    "centro/medico/admin/adminturnos/test/integration/FirstJourney",
    "centro/medico/admin/adminturnos/test/integration/TurnosListJourney",
    "centro/medico/admin/adminturnos/test/integration/TurnosObjectPageJourney",
], function (QUnit) {
    "use strict";
    QUnit.start();
});
