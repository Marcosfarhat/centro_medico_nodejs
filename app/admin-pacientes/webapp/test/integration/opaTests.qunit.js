...
sap.ui.require(
  [
    ...
    "sap/ui/qunit/qunit-junit",
    "sap/ui/qunit/qunit-coverage",
    "centro/medico/admin/adminpacientes/test/integration/FirstJourney",
    "centro/medico/admin/adminpacientes/test/integration/PacientesListJourney",
    "centro/medico/admin/adminpacientes/test/integration/PacientesObjectPageJourney",
], function (QUnit) {
    "use strict";
    QUnit.start();
});
